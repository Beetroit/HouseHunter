...
Revision ID: 6a36201818ac
Revises: 
Create Date: 2025-04-04 15:05:26.692195
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('properties', schema=None) as batch_op:
        ...
        batch_op.drop_index('ix_properties_price_per_month')
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('properties', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_properties_price_per_month', ['price_per_month'], unique=False)
